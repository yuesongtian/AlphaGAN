...
def parse_args():
    ...
    parser.add_argument(
        '--consistent',
        action='store_true',
        help='whether g_loss and d_loss are consistent')
    parser.add_argument(
        '--beta1',
        type=float,
        default=0.0,
    ...
    parser.add_argument(
        ...
        type=int,
        default=10,
        help='number of epoches to save generated images')
    parser.add_argument(
        '--eval_dg_every',
        type=int,
        default=4,
        help='number of epoches to evaluate duality gap')
    parser.add_argument(
        '--eval_dg',
        action='store_false',
        help='compute duality gap?')
    parser.add_argument(
        '--n_critic',
        type=int,
        default=1,
    ...
    parser.add_argument(
        ...
        type=str,
        default='Network_gen',
        help='name of gen model')
    parser.add_argument(
        '--dis',
        type=str,
        default='Discriminator',
        help='name of dis model')
    parser.add_argument(
        '--arch_gen',
        type=str,
        default='GAN',
        help='the architecture of trained generator')
    parser.add_argument(
        '--arch_dis',
        type=str,
        default='dis_common_loss',
        help='the architecture of trained discriminator')
    parser.add_argument(
        '--controller',
        type=str,
        default='controller',
